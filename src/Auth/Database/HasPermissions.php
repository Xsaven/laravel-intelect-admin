...
trait HasPermissions
{
    ...
    {
        if ($avatar && config('filesystems.disks.admin')) {
            return Storage::disk(config('lia.upload.disk'))->url($avatar);
        }

        return admin_asset('/vendor/lia/user-default-photo-160x160.jpg');
    }
