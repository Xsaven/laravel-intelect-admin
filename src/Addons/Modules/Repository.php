...
use Lia\Addons\Modules\Exceptions\InvalidAssetPath;
use Lia\Addons\Modules\Exceptions\ModuleNotFoundException;
use Lia\Addons\Modules\Process\Installer;
use Lia\Addons\Modules\Process\Updater;
...
abstract class Repository implements RepositoryInterface, Countable
{
     ...
     * @param $name
     * @param $path
     * @return \Lia\Addons\Modules\Module
     */
     ...
     * @return string
     * @throws \Lia\Addons\Modules\Exceptions\ModuleNotFoundException
     */
