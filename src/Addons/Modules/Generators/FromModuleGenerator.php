...
namespace Lia\Addons\Modules\Generators;
...
class FromModuleGenerator extends Generator
{
    /**
    ...
    /**
     * Get the module description in studly case.
     *
     * @return string
     */
    protected function getStudlyDescriptionReplacement()
    {
