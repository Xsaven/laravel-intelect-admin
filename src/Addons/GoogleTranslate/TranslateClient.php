...
namespace Lia\Addons\GoogleTranslate;
...
use ReflectionClass;
use Lia\Addons\GoogleTranslate\Tokens\GoogleTokenGenerator;
use Lia\Addons\GoogleTranslate\Tokens\TokenProviderInterface;
