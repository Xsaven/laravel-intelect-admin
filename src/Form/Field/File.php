...
class File extends Field
{
    ...
    protected static $css = [
        '/vendor/lia/bootstrap-fileinput/css/fileinput.min.css?v=4.3.7',
    ];
     ...
     */
    protected static $js = [
        '/vendor/lia/bootstrap-fileinput/js/plugins/canvas-to-blob.min.js?v=4.3.7',
        '/vendor/lia/bootstrap-fileinput/js/fileinput.min.js?v=4.3.7',
    ];
    ...
    {
        return config('lia.upload.directory.file');
    }
