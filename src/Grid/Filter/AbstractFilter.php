...
use Lia\Grid\Filter;
use Lia\Grid\Filter\Presenter\Checkbox;
use Lia\Grid\Filter\Presenter\DateTime;
use Lia\Grid\Filter\Presenter\MultipleSelect;
use Lia\Grid\Filter\Presenter\Presenter;
use Lia\Grid\Filter\Presenter\Radio;
use Lia\Grid\Filter\Presenter\Select;
use Lia\Grid\Filter\Presenter\Text;
...
abstract class AbstractFilter
{
     ...
     * @var string
     */
    protected $view = 'lia::filter.where';
