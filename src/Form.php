...
use Lia\Form\Builder;
use Lia\Form\Field;
use Lia\Form\Field\File;
use Lia\Form\Row;
use Lia\Form\Tab;
...
//        static::doNotSnakeAttributes($this->model);
    ...
    {
        $map = [
            'button'         => \Lia\Form\Field\Button::class,
            'checkbox'       => \Lia\Form\Field\Checkbox::class,
            'color'          => \Lia\Form\Field\Color::class,
            'currency'       => \Lia\Form\Field\Currency::class,
            'date'           => \Lia\Form\Field\Date::class,
            'dateRange'      => \Lia\Form\Field\DateRange::class,
            'datetime'       => \Lia\Form\Field\Datetime::class,
            'dateTimeRange'  => \Lia\Form\Field\DatetimeRange::class,
            'datetimeRange'  => \Lia\Form\Field\DatetimeRange::class,
            'decimal'        => \Lia\Form\Field\Decimal::class,
            'display'        => \Lia\Form\Field\Display::class,
            'divider'        => \Lia\Form\Field\Divide::class,
            'divide'         => \Lia\Form\Field\Divide::class,
            'embeds'         => \Lia\Form\Field\Embeds::class,
            'editor'         => \Lia\Form\Field\Editor::class,
            'email'          => \Lia\Form\Field\Email::class,
            'file'           => \Lia\Form\Field\File::class,
            'hasMany'        => \Lia\Form\Field\HasMany::class,
            'hidden'         => \Lia\Form\Field\Hidden::class,
            'id'             => \Lia\Form\Field\Id::class,
            'image'          => \Lia\Form\Field\Image::class,
            'ip'             => \Lia\Form\Field\Ip::class,
            'map'            => \Lia\Form\Field\Map::class,
            'mobile'         => \Lia\Form\Field\Mobile::class,
            'month'          => \Lia\Form\Field\Month::class,
            'multipleSelect' => \Lia\Form\Field\MultipleSelect::class,
            'number'         => \Lia\Form\Field\Number::class,
            'password'       => \Lia\Form\Field\Password::class,
            'radio'          => \Lia\Form\Field\Radio::class,
            'rate'           => \Lia\Form\Field\Rate::class,
            'select'         => \Lia\Form\Field\Select::class,
            'slider'         => \Lia\Form\Field\Slider::class,
            'switch'         => \Lia\Form\Field\SwitchField::class,
            'text'           => \Lia\Form\Field\Text::class,
            'textarea'       => \Lia\Form\Field\Textarea::class,
            'time'           => \Lia\Form\Field\Time::class,
            'timeRange'      => \Lia\Form\Field\TimeRange::class,
            'url'            => \Lia\Form\Field\Url::class,
            'year'           => \Lia\Form\Field\Year::class,
            'html'           => \Lia\Form\Field\Html::class,
            'tags'           => \Lia\Form\Field\Tags::class,
            'icon'           => \Lia\Form\Field\Icon::class,
            'multipleFile'   => \Lia\Form\Field\MultipleFile::class,
            'multipleImage'  => \Lia\Form\Field\MultipleImage::class,
            'captcha'        => \Lia\Form\Field\Captcha::class,
            'listbox'        => \Lia\Form\Field\Listbox::class,
        ];
