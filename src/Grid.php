...
use Lia\Grid\Column;
use Lia\Grid\Displayers\Actions;
use Lia\Grid\Displayers\RowSelector;
use Lia\Grid\Exporter;
use Lia\Grid\Filter;
use Lia\Grid\Model;
use Lia\Grid\Row;
use Lia\Grid\Tools;
...
class Grid
{
    ...
    {
        $map = [
            'editable'    => \Lia\Grid\Displayers\Editable::class,
            'switch'      => \Lia\Grid\Displayers\SwitchDisplay::class,
            'switchGroup' => \Lia\Grid\Displayers\SwitchGroup::class,
            'select'      => \Lia\Grid\Displayers\Select::class,
            'image'       => \Lia\Grid\Displayers\Image::class,
            'label'       => \Lia\Grid\Displayers\Label::class,
            'button'      => \Lia\Grid\Displayers\Button::class,
            'link'        => \Lia\Grid\Displayers\Link::class,
            'badge'       => \Lia\Grid\Displayers\Badge::class,
            'progressBar' => \Lia\Grid\Displayers\ProgressBar::class,
            'radio'       => \Lia\Grid\Displayers\Radio::class,
            'checkbox'    => \Lia\Grid\Displayers\Checkbox::class,
            'orderable'   => \Lia\Grid\Displayers\Orderable::class,
        ];
