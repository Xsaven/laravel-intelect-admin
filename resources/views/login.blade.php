...
<head>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="{{ admin_asset("/vendor/lia/AdminLTE/plugins/iCheck/square/blue.css") }}">
...
<div class="login-box">
  <div class="login-logo">
    <a href="{{ admin_base_path('/') }}"><b>{{config('lia.name')}}</b></a>
  </div>
  <!-- /.login-logo -->
...
<!-- iCheck -->
<script src="{{ admin_asset("/vendor/lia/AdminLTE/plugins/iCheck/icheck.min.js")}}"></script>
<script>
  $(function () {
    $('input').iCheck({
